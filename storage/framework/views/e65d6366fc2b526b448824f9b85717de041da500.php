...
<?php $__env->startSection('PageTitle', 'Brands'); ?>
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="<?php echo e(route($role . '-profile')); ?>"><i class="bx
                    bx-home-alt"></i></a></li>
                ...
                <table id="data_table" class="table table-striped table-bordered">
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($item->brand_slug); ?></td>
                            <td>
                                <button type="button" class="btn btn-primary btn-sm radius-30 px-4"
                                        data-bs-toggle="modal"
                                        data-bs-target="#exampleVerticallycenteredModal-<?php echo e($item->brand_id); ?>">View
                                    Details
                                </button>
                                <!-- Modal -->
                                <div class="modal fade" id="exampleVerticallycenteredModal-<?php echo e($item->brand_id); ?>"
                                     tabindex="-1"
                                     aria-hidden="true">
                            ...
                            <td>
                                <div class="d-flex order-actions">
                                    <a href="" class="" data-bs-toggle="modal"
                                       data-bs-target="#exampleFullScreenModal-<?php echo e($item->brand_id); ?>"><i class='bx
                                       bxs-edit'></i></a>

                                    <div class="modal fade" id="exampleFullScreenModal-<?php echo e($item->brand_id); ?>"
                                         tabindex="-1"
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <form class="brand_form" action="update_brand" method="POST"
                                                                ...
                                                                <?php echo csrf_field(); ?>
                                                                <input name="brand_id" value="<?php echo e($item->brand_id); ?>"
                                                                       hidden/>
                                                                <div class="row mb-3">
                                                                    <div class="col-sm-3">
                                                                    ...
                                                                    <div class="col-sm-9 text-secondary">
                                                                        <input name="brand_name" type="text"
                                                                               class="form-control"
                                                                               value="<?php echo e($item->brand_name); ?>"
                                                                               required autofocus/>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-9 text-secondary">
                                                                        ...
                                                                        <div>
                                                                            <img class="card-img-top" src="<?php echo e(url
                                    ...
                                    <a href="" class="ms-3" data-bs-toggle="modal"
                                       data-bs-target="#exampleDangerModal-<?php echo e($item->brand_id); ?>">

                                        <i class='bx bxs-trash'></i>
                                        <!-- Modal -->
                                        <div class="modal fade" id="exampleDangerModal-<?php echo e($item->brand_id); ?>"
                                            ...
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content bg-danger">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        ('remove_brand/<?php echo e($item->brand_id); ?>');"
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\vendor-eCommerce\resources\views/backend/brand/brand_default.blade.php ENDPATH**/ ?>