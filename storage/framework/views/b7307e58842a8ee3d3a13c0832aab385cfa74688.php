                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                <form id="profile_image" method="POST" action="<?php echo e(route('admin-profile-image-update')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                    <img id="show_image" src="<?php echo e(!empty($data->photo) ?
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            <form id="info_form" action="<?php echo e(route('admin-profile-info-update')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="email" type="email" class="form-control" value="<?php echo e($data->email); ?>" required/>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="phone_number" type="text" class="form-control"
                                               value="<?php echo e($data->phone_number); ?>" placeholder="Your phone number" />
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input name="address" type="text"
                                               class="form-control"
                                               value="<?php echo e($data->address); ?>" placeholder="Your address"/>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <form id="password_form" action="<?php echo e(route('admin-profile-password-update')); ?>"
                                          method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="row mb-3">
                                            <div class="col-sm-3">
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('#info_form').on('submit', function(event){
                ...
                $.ajax({
                    url: "<?php echo e(route('admin-profile-info-update')); ?>",
                    method: 'POST',
        ...
        $(document).ready(function(){
            $('#password_form').on('submit', function(event){
                ...
                $.ajax({
                    url: "<?php echo e(route('admin-profile-password-update')); ?>",
                    method: 'POST',
                    data: new FormData(this),
                    dataType: 'JSON',
                    contentType: false,
        ...
        $(document).ready(function(){
            $('#profile_image').on('submit', function(event){
                ...
                $.ajax({
                    url: "<?php echo e(route('admin-profile-image-update')); ?>",
                    method: 'POST',
                    data: new FormData(this),
                    dataType: 'JSON',
                    contentType: false,
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\vendor-eCommerce\resources\views/backend/profile/admin_profile.blade.php ENDPATH**/ ?>